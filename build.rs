...
fn main()
{
    ...
    // located executable path even if the project is in workspace
...
fn locate_target_dir_from_output_dir(mut target_dir_search: &Path)
-> Option<&Path>
{
    loop {
        // if the path ends with target we assume it is the right dir
